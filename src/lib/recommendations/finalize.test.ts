...
describe("finalizeScores — deep-cut-aware desirability", () => {
  // Isolate the desirability term: zero out relevance and rating so only
  // want-count-driven desirability decides ranking.
  const desirabilityOnly = { relevance: 0, rating: 0, desirability: 1 };
